...
```
Available to view in requirements.txt
```
...
| Module | Description |
|---|---|
| `bg_query.py` | Query the google cloud depository |
| `bg_plotting.py` | light curve plots, ... |
| `bg_logger.py` | console logger |
| `bg_stack_lcs.py` | Combine all BG lightcurves to make a multi-night lightcurve fits file per target |
